...
public class KbApi {
  ...
  public KbApi(RestClient restClient) {
    this.restClient = restClient;
  }

  /**
   * Get articles
   * <p>Returns articles which match the given query string across all service desks.</p> <p><strong><a href=\"#permissions\">Permissions</a> required</strong>: Permission to access the <a href=\"https://confluence.atlassian.com/servicedeskcloud/configuring-the-customer-portal-732528918.html\">customer portal</a>.</p> 
   * @param query <p>The string used to filter the articles (required).</p>  (optional)
   * @param highlight <p>If set to true matching query term in the title and excerpt will be highlighted using the {@code @@@hl@@@term@@@endhl@@@} syntax. Default: false.</p>  (optional, default to false)
  ...
  public Single<PagedDTOArticleDTO> getArticles(
    Optional<String> query, Optional<Boolean> highlight, Optional<Integer> start, Optional<Integer> limit, Optional<RestRequestEnhancer> restRequestEnhancer) {
