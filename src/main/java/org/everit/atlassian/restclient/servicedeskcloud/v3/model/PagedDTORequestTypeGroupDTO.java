...
import org.everit.atlassian.restclient.servicedeskcloud.v3.model.RequestTypeGroupDTO;
...
public class PagedDTORequestTypeGroupDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<RequestTypeGroupDTO> values = new ArrayList<>();
  ...
  public PagedDTORequestTypeGroupDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTORequestTypeGroupDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTORequestTypeGroupDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTORequestTypeGroupDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTORequestTypeGroupDTO values(List<RequestTypeGroupDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTORequestTypeGroupDTO addValuesItem(RequestTypeGroupDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<RequestTypeGroupDTO> getValues() {
    return values;
  }

  public void setValues(List<RequestTypeGroupDTO> values) {
    this.values = values;
  }

  public PagedDTORequestTypeGroupDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTORequestTypeGroupDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTORequestTypeGroupDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTORequestTypeGroupDTO pagedDTORequestTypeGroupDTO = (PagedDTORequestTypeGroupDTO) o;
    return Objects.equals(this.size, pagedDTORequestTypeGroupDTO.size) &&
        Objects.equals(this.start, pagedDTORequestTypeGroupDTO.start) &&
        Objects.equals(this.limit, pagedDTORequestTypeGroupDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTORequestTypeGroupDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTORequestTypeGroupDTO.values) &&
        Objects.equals(this.expands, pagedDTORequestTypeGroupDTO.expands) &&
        Objects.equals(this.links, pagedDTORequestTypeGroupDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTORequestTypeGroupDTO {\n");
