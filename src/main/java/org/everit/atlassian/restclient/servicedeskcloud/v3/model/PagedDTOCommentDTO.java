...
public class PagedDTOCommentDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<CommentDTO> values = new ArrayList<>();
  ...
  public PagedDTOCommentDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOCommentDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOCommentDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOCommentDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOCommentDTO values(List<CommentDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOCommentDTO addValuesItem(CommentDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<CommentDTO> getValues() {
    return values;
  }

  public void setValues(List<CommentDTO> values) {
    this.values = values;
  }

  public PagedDTOCommentDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOCommentDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOCommentDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOCommentDTO pagedDTOCommentDTO = (PagedDTOCommentDTO) o;
    return Objects.equals(this.size, pagedDTOCommentDTO.size) &&
        Objects.equals(this.start, pagedDTOCommentDTO.start) &&
        Objects.equals(this.limit, pagedDTOCommentDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOCommentDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOCommentDTO.values) &&
        Objects.equals(this.expands, pagedDTOCommentDTO.expands) &&
        Objects.equals(this.links, pagedDTOCommentDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOCommentDTO {\n");
