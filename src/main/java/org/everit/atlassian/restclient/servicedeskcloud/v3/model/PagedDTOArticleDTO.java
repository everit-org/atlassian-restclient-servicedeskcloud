...
import org.everit.atlassian.restclient.servicedeskcloud.v3.model.ArticleDTO;
...
public class PagedDTOArticleDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<ArticleDTO> values = new ArrayList<>();
  ...
  public PagedDTOArticleDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOArticleDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOArticleDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOArticleDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOArticleDTO values(List<ArticleDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOArticleDTO addValuesItem(ArticleDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<ArticleDTO> getValues() {
    return values;
  }

  public void setValues(List<ArticleDTO> values) {
    this.values = values;
  }

  public PagedDTOArticleDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOArticleDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOArticleDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOArticleDTO pagedDTOArticleDTO = (PagedDTOArticleDTO) o;
    return Objects.equals(this.size, pagedDTOArticleDTO.size) &&
        Objects.equals(this.start, pagedDTOArticleDTO.start) &&
        Objects.equals(this.limit, pagedDTOArticleDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOArticleDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOArticleDTO.values) &&
        Objects.equals(this.expands, pagedDTOArticleDTO.expands) &&
        Objects.equals(this.links, pagedDTOArticleDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOArticleDTO {\n");
