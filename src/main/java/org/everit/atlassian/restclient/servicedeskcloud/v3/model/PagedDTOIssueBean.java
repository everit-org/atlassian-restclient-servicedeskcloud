...
import org.everit.atlassian.restclient.servicedeskcloud.v3.model.IssueBean;
...
public class PagedDTOIssueBean {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<IssueBean> values = new ArrayList<>();
  ...
  public PagedDTOIssueBean size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOIssueBean start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOIssueBean limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOIssueBean isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOIssueBean values(List<IssueBean> values) {
    this.values = values;
    return this;
  }

  public PagedDTOIssueBean addValuesItem(IssueBean valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<IssueBean> getValues() {
    return values;
  }

  public void setValues(List<IssueBean> values) {
    this.values = values;
  }

  public PagedDTOIssueBean expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOIssueBean addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOIssueBean links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOIssueBean pagedDTOIssueBean = (PagedDTOIssueBean) o;
    return Objects.equals(this.size, pagedDTOIssueBean.size) &&
        Objects.equals(this.start, pagedDTOIssueBean.start) &&
        Objects.equals(this.limit, pagedDTOIssueBean.limit) &&
        Objects.equals(this.isLastPage, pagedDTOIssueBean.isLastPage) &&
        Objects.equals(this.values, pagedDTOIssueBean.values) &&
        Objects.equals(this.expands, pagedDTOIssueBean.expands) &&
        Objects.equals(this.links, pagedDTOIssueBean.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOIssueBean {\n");
