...
public class PagedDTOServiceDeskDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<ServiceDeskDTO> values = new ArrayList<>();
  ...
  public PagedDTOServiceDeskDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOServiceDeskDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOServiceDeskDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOServiceDeskDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOServiceDeskDTO values(List<ServiceDeskDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOServiceDeskDTO addValuesItem(ServiceDeskDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<ServiceDeskDTO> getValues() {
    return values;
  }

  public void setValues(List<ServiceDeskDTO> values) {
    this.values = values;
  }

  public PagedDTOServiceDeskDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOServiceDeskDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOServiceDeskDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOServiceDeskDTO pagedDTOServiceDeskDTO = (PagedDTOServiceDeskDTO) o;
    return Objects.equals(this.size, pagedDTOServiceDeskDTO.size) &&
        Objects.equals(this.start, pagedDTOServiceDeskDTO.start) &&
        Objects.equals(this.limit, pagedDTOServiceDeskDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOServiceDeskDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOServiceDeskDTO.values) &&
        Objects.equals(this.expands, pagedDTOServiceDeskDTO.expands) &&
        Objects.equals(this.links, pagedDTOServiceDeskDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOServiceDeskDTO {\n");
