...
public class PagedDTORequestTypeDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<RequestTypeDTO> values = new ArrayList<>();
  ...
  public PagedDTORequestTypeDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTORequestTypeDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTORequestTypeDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTORequestTypeDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTORequestTypeDTO values(List<RequestTypeDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTORequestTypeDTO addValuesItem(RequestTypeDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<RequestTypeDTO> getValues() {
    return values;
  }

  public void setValues(List<RequestTypeDTO> values) {
    this.values = values;
  }

  public PagedDTORequestTypeDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTORequestTypeDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTORequestTypeDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTORequestTypeDTO pagedDTORequestTypeDTO = (PagedDTORequestTypeDTO) o;
    return Objects.equals(this.size, pagedDTORequestTypeDTO.size) &&
        Objects.equals(this.start, pagedDTORequestTypeDTO.start) &&
        Objects.equals(this.limit, pagedDTORequestTypeDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTORequestTypeDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTORequestTypeDTO.values) &&
        Objects.equals(this.expands, pagedDTORequestTypeDTO.expands) &&
        Objects.equals(this.links, pagedDTORequestTypeDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTORequestTypeDTO {\n");
