 ...
 */
package org.everit.atlassian.restclient.servicedeskcloud.util;
...
public class ServicedeskCloudJSONObjectMapper implements JSONObjectMapper {
  ...
  private static class OffsetDateTimeDeserializer extends InstantDeserializer<OffsetDateTime> {
    ...
    OffsetDateTimeDeserializer() {
      super(
          ...
          ServicedeskCloudJSONObjectMapper.SERVICEDESK_CLOUD_DATETIME_FORMATTER,
          OffsetDateTime::from,
  ...
  private static class OffsetDateTimeSerializer extends InstantSerializerBase<OffsetDateTime> {
    ...
    protected OffsetDateTimeSerializer(OffsetDateTimeSerializer base,
      ...
      this(base, useTimestamp, null, ServicedeskCloudJSONObjectMapper.SERVICEDESK_CLOUD_DATETIME_FORMATTER);
    }
   ...
   */
  public static final DateTimeFormatter SERVICEDESK_CLOUD_DATETIME_FORMATTER;

  static {
    SERVICEDESK_CLOUD_DATETIME_FORMATTER =
        new DateTimeFormatterBuilder()
            .append(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSZ"))
            .toFormatter();

    INSTANCE = new ServicedeskCloudJSONObjectMapper();
  }

  private final ObjectMapper objectMapper;

  public ServicedeskCloudJSONObjectMapper() {
