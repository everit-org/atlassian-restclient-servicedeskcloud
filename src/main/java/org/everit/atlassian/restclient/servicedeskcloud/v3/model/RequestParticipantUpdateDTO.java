...
public class RequestParticipantUpdateDTO {
  ...
  public RequestParticipantUpdateDTO usernames(List<String> usernames) {
    this.usernames = usernames;
    return this;
  }

  public RequestParticipantUpdateDTO addUsernamesItem(String usernamesItem) {
  ...
  **/
  ...
  public RequestParticipantUpdateDTO accountIds(List<String> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public RequestParticipantUpdateDTO addAccountIdsItem(String accountIdsItem) {
   ...
   * @return accountIds
  **/
  @ApiModelProperty(value = "List of users, specified by account IDs, to add to or remove as participants in the request.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RequestParticipantUpdateDTO requestParticipantUpdateDTO = (RequestParticipantUpdateDTO) o;
    return Objects.equals(this.usernames, requestParticipantUpdateDTO.usernames) &&
        Objects.equals(this.accountIds, requestParticipantUpdateDTO.accountIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestParticipantUpdateDTO {\n");
