...
import org.everit.atlassian.restclient.servicedeskcloud.v3.model.AttachmentDTO;
...
public class PagedDTOAttachmentDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<AttachmentDTO> values = new ArrayList<>();
  ...
  public PagedDTOAttachmentDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOAttachmentDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOAttachmentDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOAttachmentDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOAttachmentDTO values(List<AttachmentDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOAttachmentDTO addValuesItem(AttachmentDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<AttachmentDTO> getValues() {
    return values;
  }

  public void setValues(List<AttachmentDTO> values) {
    this.values = values;
  }

  public PagedDTOAttachmentDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOAttachmentDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOAttachmentDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOAttachmentDTO pagedDTOAttachmentDTO = (PagedDTOAttachmentDTO) o;
    return Objects.equals(this.size, pagedDTOAttachmentDTO.size) &&
        Objects.equals(this.start, pagedDTOAttachmentDTO.start) &&
        Objects.equals(this.limit, pagedDTOAttachmentDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOAttachmentDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOAttachmentDTO.values) &&
        Objects.equals(this.expands, pagedDTOAttachmentDTO.expands) &&
        Objects.equals(this.links, pagedDTOAttachmentDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOAttachmentDTO {\n");
