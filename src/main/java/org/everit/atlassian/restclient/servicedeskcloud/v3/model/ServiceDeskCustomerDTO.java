...
public class ServiceDeskCustomerDTO {
  ...
  public ServiceDeskCustomerDTO usernames(List<String> usernames) {
    this.usernames = usernames;
    return this;
  }

  public ServiceDeskCustomerDTO addUsernamesItem(String usernamesItem) {
  ...
  **/
  ...
  public ServiceDeskCustomerDTO accountIds(List<String> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public ServiceDeskCustomerDTO addAccountIdsItem(String accountIdsItem) {
   ...
   * @return accountIds
  **/
  @ApiModelProperty(value = "List of users, specified by account IDs, to add to or remove from a service desk.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ServiceDeskCustomerDTO serviceDeskCustomerDTO = (ServiceDeskCustomerDTO) o;
    return Objects.equals(this.usernames, serviceDeskCustomerDTO.usernames) &&
        Objects.equals(this.accountIds, serviceDeskCustomerDTO.accountIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceDeskCustomerDTO {\n");
