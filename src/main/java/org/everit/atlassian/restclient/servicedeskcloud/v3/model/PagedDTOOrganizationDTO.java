...
public class PagedDTOOrganizationDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<OrganizationDTO> values = new ArrayList<>();
  ...
  public PagedDTOOrganizationDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOOrganizationDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOOrganizationDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOOrganizationDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOOrganizationDTO values(List<OrganizationDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOOrganizationDTO addValuesItem(OrganizationDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<OrganizationDTO> getValues() {
    return values;
  }

  public void setValues(List<OrganizationDTO> values) {
    this.values = values;
  }

  public PagedDTOOrganizationDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOOrganizationDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOOrganizationDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOOrganizationDTO pagedDTOOrganizationDTO = (PagedDTOOrganizationDTO) o;
    return Objects.equals(this.size, pagedDTOOrganizationDTO.size) &&
        Objects.equals(this.start, pagedDTOOrganizationDTO.start) &&
        Objects.equals(this.limit, pagedDTOOrganizationDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOOrganizationDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOOrganizationDTO.values) &&
        Objects.equals(this.expands, pagedDTOOrganizationDTO.expands) &&
        Objects.equals(this.links, pagedDTOOrganizationDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOOrganizationDTO {\n");
