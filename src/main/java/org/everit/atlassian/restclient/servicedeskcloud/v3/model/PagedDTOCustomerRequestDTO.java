...
public class PagedDTOCustomerRequestDTO {
  ...
  @JsonProperty("values")
  private List<CustomerRequestDTO> values = new ArrayList<>();
  ...
  public PagedDTOCustomerRequestDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOCustomerRequestDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOCustomerRequestDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOCustomerRequestDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOCustomerRequestDTO values(List<CustomerRequestDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOCustomerRequestDTO addValuesItem(CustomerRequestDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<CustomerRequestDTO> getValues() {
    return values;
  }

  public void setValues(List<CustomerRequestDTO> values) {
    this.values = values;
  }

  public PagedDTOCustomerRequestDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOCustomerRequestDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOCustomerRequestDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOCustomerRequestDTO pagedDTOCustomerRequestDTO = (PagedDTOCustomerRequestDTO) o;
    return Objects.equals(this.size, pagedDTOCustomerRequestDTO.size) &&
        Objects.equals(this.start, pagedDTOCustomerRequestDTO.start) &&
        Objects.equals(this.limit, pagedDTOCustomerRequestDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOCustomerRequestDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOCustomerRequestDTO.values) &&
        Objects.equals(this.expands, pagedDTOCustomerRequestDTO.expands) &&
        Objects.equals(this.links, pagedDTOCustomerRequestDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOCustomerRequestDTO {\n");
