...
public class PagedDTOSlaInformationDTO {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<SlaInformationDTO> values = new ArrayList<>();
  ...
  public PagedDTOSlaInformationDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOSlaInformationDTO start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOSlaInformationDTO limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PagedDTOSlaInformationDTO isLastPage(Boolean isLastPage) {
  ...
  **/
  ...
  public PagedDTOSlaInformationDTO values(List<SlaInformationDTO> values) {
    this.values = values;
    return this;
  }

  public PagedDTOSlaInformationDTO addValuesItem(SlaInformationDTO valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public List<SlaInformationDTO> getValues() {
    return values;
  }

  public void setValues(List<SlaInformationDTO> values) {
    this.values = values;
  }

  public PagedDTOSlaInformationDTO expands(List<String> expands) {
    this.expands = expands;
    return this;
  }

  public PagedDTOSlaInformationDTO addExpandsItem(String expandsItem) {
  ...
  **/
  ...
  public PagedDTOSlaInformationDTO links(PagedLinkDTO links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedDTOSlaInformationDTO pagedDTOSlaInformationDTO = (PagedDTOSlaInformationDTO) o;
    return Objects.equals(this.size, pagedDTOSlaInformationDTO.size) &&
        Objects.equals(this.start, pagedDTOSlaInformationDTO.start) &&
        Objects.equals(this.limit, pagedDTOSlaInformationDTO.limit) &&
        Objects.equals(this.isLastPage, pagedDTOSlaInformationDTO.isLastPage) &&
        Objects.equals(this.values, pagedDTOSlaInformationDTO.values) &&
        Objects.equals(this.expands, pagedDTOSlaInformationDTO.expands) &&
        Objects.equals(this.links, pagedDTOSlaInformationDTO.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedDTOSlaInformationDTO {\n");
